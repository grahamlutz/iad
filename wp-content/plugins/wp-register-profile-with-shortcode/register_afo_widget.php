...
class register_wid extends WP_Widget {
	...
	public function registerForm(){
		...
		<?php 
			...
			echo '<div id="reg_forms" class="reg_forms"><p>'.__('Sorry. Registration is not allowed in this site.','wp-register-profile-with-shortcode').'</p></div>';
		}
		}
	}
	...
	public function create_user( $data = array() ){
		...
		$wprw_success_msg = get_option( 'wprw_success_msg' );
